...
contract MiMC_BLS12_377 {
    ...
    function Hash_bls12_377(uint256[] memory in_msgs, uint256 in_key) private pure returns (uint256) {
        bytes4 seed = 0x6d696d63; //this is 'mimc' in hex
        return MiMCp_mp_bls12_377(in_msgs, in_key, uint256(keccak256(abi.encodePacked(seed))), 74);
    }

    function mimc_bls12_377(uint256[] memory in_msgs) public pure returns (uint256) {
